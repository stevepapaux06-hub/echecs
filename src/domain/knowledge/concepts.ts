...
export const CHESSPATH_CONCEPTS: readonly ConceptDefinition[] = [
  ...
  { conceptSlug: "open_file", category: "strategy", labelFr: "Colonne ouverte / semi-ouverte", shortDescription: "Exploiter une colonne ouverte, ou presser une cible sur une colonne semi-ouverte.", detectionStatus: "detected", detectionMethod: "État strict de la colonne conservé dans les faits; exploitation ouverte et pression semi-ouverte sont deux mécanismes internes distincts." },
