...
export const CHESSPATH_CONCEPTS: readonly ConceptDefinition[] = [
  ...
  { conceptSlug: "improve_worst_piece", category: "strategy", labelFr: "Améliorer la pire pièce", shortDescription: "Activer la pièce qui participe le moins au jeu.", detectionStatus: "planned", detectionMethod: "Prévu avec une mesure d’activité plus robuste." },
  ...
  { conceptSlug: "pawn_break", category: "strategy", labelFr: "Rupture de pions", shortDescription: "Changer la structure par une poussée préparée.", detectionStatus: "planned", detectionMethod: "Prévu avec validation structurelle et Stockfish." },
  ...
  { conceptSlug: "weak_pawn", category: "strategy", labelFr: "Pion faible", shortDescription: "Fixer puis attaquer un pion durablement vulnérable.", detectionStatus: "planned", detectionMethod: "Prévu après mesure fiable des défenseurs et des ruptures." },
  ...
  { conceptSlug: "rook_activity", category: "endgame", labelFr: "Activité de la tour", shortDescription: "Donner à la tour des cibles, des lignes et du contre-jeu.", detectionStatus: "planned", detectionMethod: "Prévu avec mobilité et accès aux rangées actives." },
